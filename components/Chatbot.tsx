...
const Chatbot: React.FC = () => {
    ...
    const personalInfo = `
        Syed Ali Hashmi is a 2nd-year Software Engineering student at UBIT, Karachi University. He is a Frontend Developer passionate about AI and Machine Learning. He enjoys building interactive web projects and exploring intelligent solutions. He is also enrolled in the Certified Cloud Applied Generative AI course under the Governor Sindh Pakistan Initiative, enhancing his expertise in AI applications. He is committed to applying his skills to innovative projects that drive technological advancement. His skills include React, TypeScript, Next.js, Node.js, Express, Tailwind CSS, Git, Figma, and MongoDB.
    `;
        ...
        if (isOpen && !chatRef.current) {
            try {
                ...
                if (!apiKey) {
                    ...
                    setMessages([{ role: 'model', text: "The AI feature is not configured correctly. Please contact the site owner." }]);
                    return;
                }
